defmodule SnowtrackWeb.RegisterLive do
  ...
  def render(assigns) do
    ...
    title =
      if assigns.changeset.action == :success,
        do: dgettext("accounts", "Confirm your email"),
        else: dgettext("accounts", "Register and start monitoring your apps")
    ...
    case Accounts.register_user(changeset["user"]) do
      {:ok, user} ->
        ...
        {:noreply,
         ...
         |> assign(changeset: changeset |> Map.put(:action, :success))}
